...
static void test_SQLGetInstalledDrivers(void)
{
    ...
    ok(ret, "got %d\n", ret);
    ok(strlen(buffer) == len-2, "expected len %d, got %zu\n", len-2, strlen(buffer));
    ...
    ok(ret, "got %d\n", ret);
    ok(strlen(buffer) == len-1, "expected len %d, got %zu\n", len-1, strlen(buffer));
    ...
    ok(ret, "got %d\n", ret);
    ok(strlen(buffer) == len, "expected len %d, got %zu\n", len, strlen(buffer));
