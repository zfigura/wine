...
static void test_connect_pin(void)
{
    ...
    IBaseFilter *reader, *splitter = create_wave_parser();
    ...
    IBaseFilter_FindPin(splitter, source_name, &splitter_source);
...
static void test_filter_state(void)
{
    ...
    const WCHAR *filename = load_resource(wavefile);
    IBaseFilter *splitter = create_wave_parser();
    ...
    IBaseFilter_FindPin(splitter, source_name, &source);
