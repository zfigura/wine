        ...
        IUnknown *outer, REFIID iid, void **out)
{
    ...
    *out = NULL;
    ...
    return dmo_wrapper_create(outer, iid, out);
}
...
static IClassFactory dmo_wrapper_cf = {&class_factory_vtbl};
...
BOOL WINAPI DllMain(HINSTANCE instance, DWORD reason, void *reserved)
{
    ...
    else if (reason == DLL_WINE_PREATTACH)
...
HRESULT WINAPI DllGetClassObject(REFCLSID clsid, REFIID iid, void **out)
{
    ...
    if (IsEqualGUID(clsid, &CLSID_DMOWrapperFilter))
        return IClassFactory_QueryInterface(&dmo_wrapper_cf, iid, out);
