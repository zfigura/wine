...
static HRESULT WINAPI DMOWrapperFilter_QueryInterface(IBaseFilter *iface, REFIID riid, void **ppv)
{
...
static ULONG WINAPI DMOWrapperFilter_Release(IBaseFilter *iface)
{
    struct dmo_wrapper *This = impl_from_IBaseFilter(iface);
...
static const IBaseFilterVtbl DMOWrapperFilter_vtbl = {
...
IUnknown * WINAPI QASF_createDMOWrapperFilter(IUnknown *outer, HRESULT *hr)
{
    ...
    BaseFilter_Init(&This->filter, &DMOWrapperFilter_vtbl, &CLSID_DMOWrapperFilter,
