...
#include "uuids.h"
    ...
    X(MEDIASUBTYPE_AVC1),
    X(MEDIASUBTYPE_DOLBY_DDPLUS),
    X(MEDIASUBTYPE_DOLBY_TRUEHD),
    X(MEDIASUBTYPE_DTS_HD),
    X(MEDIASUBTYPE_DTS2),
    X(MEDIASUBTYPE_DVM),
    X(MEDIASUBTYPE_I420),
    X(MEDIASUBTYPE_M4S2),
    ...
    X(MEDIASUBTYPE_MP43),
    X(MEDIASUBTYPE_MP4S),
    X(MEDIASUBTYPE_MPEG_ADTS_AAC),
    X(MEDIASUBTYPE_MPEG_HEAAC),
    X(MEDIASUBTYPE_MPEG_LOAS),
    X(MEDIASUBTYPE_MPEG_RAW_AAC),
    X(MEDIASUBTYPE_MPG4),
    X(MEDIASUBTYPE_MSAUDIO1),
    X(MEDIASUBTYPE_MSS1),
    X(MEDIASUBTYPE_MSS2),
    X(MEDIASUBTYPE_NOKIA_MPEG_ADTS_AAC),
    X(MEDIASUBTYPE_NOKIA_MPEG_RAW_AAC),
    X(MEDIASUBTYPE_RAW_AAC1),
    X(MEDIASUBTYPE_V216),
    X(MEDIASUBTYPE_V410),
    X(MEDIASUBTYPE_VODAFONE_MPEG_ADTS_AAC),
    X(MEDIASUBTYPE_VODAFONE_MPEG_RAW_AAC),
    X(MEDIASUBTYPE_WMASPDIF),
    X(MEDIASUBTYPE_WMAUDIO_LOSSLESS),
    X(MEDIASUBTYPE_WMAUDIO2),
    X(MEDIASUBTYPE_WMAUDIO3),
    X(MEDIASUBTYPE_WMAUDIO4),
    X(MEDIASUBTYPE_WMV1),
    X(MEDIASUBTYPE_WMV2),
    X(MEDIASUBTYPE_WMV3),
    X(MEDIASUBTYPE_WMVA),
    ...
    /* Windows Media SDK GUIDs not defined above. */
    X(WMFORMAT_MPEG2Video),
    X(WMFORMAT_Script),
    X(WMFORMAT_WebStream),
    X(WMMEDIASUBTYPE_ACELPnet),
    X(WMMEDIASUBTYPE_MP3),
